...
class FastTemplate {
	...
	public $DYNAMIC	= array();	//	Holds the array of dynamic
	...
	public $HANDLE = array();	//	Holds the handle names assigned
					//	by a call to parse()
...
//	************************************************************
	...
	public function __construct ($pathToTemplates = "",$os = "")
	{
		global $php_errormsg;
...
//  **************************************************************
//  call this function if the OS is WIN32
	public function set_win32 ()
	{
          $this->WIN32 = true;
	}
...
//	************************************************************
	...
	public function clear__parse ( $ReturnVar = "")
	{
